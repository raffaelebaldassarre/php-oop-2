<?php 
    ...
    class Editor extends User{
        ...
        public function __construct(string $name, string $lastname, string $nickname, int $age, string $gender, bool $gestisce_ruoli_e_impostazioni=0, bool $modifica_pagina_e_agginge_app=1, bool $crea_elimina_post=1, bool $invia_messaggi_a_nome_pagina=1){
